...
function createStyles(theme: ThemePalette, textScale: number) {
  ...
  return StyleSheet.create({
    ...
    extrasLabel: { fontSize: scaled(9), color: '#aaaaaa', ...(theme.fontFamily ? { fontFamily: theme.fontFamily } : {}) },
    extrasValue: { fontSize: scaled(10), color: '#aaaaaa', fontWeight: '600', ...(theme.fontFamily ? { fontFamily: theme.fontFamily } : {}) },
