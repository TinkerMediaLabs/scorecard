...
export const THEMES: Record<Theme, ThemePalette> = {
  whiteboard: {
    ...
    shareButton: { backgroundColor: '#e0e0e0', textColor: '#155843', fontSize: 13, fontWeight: '700' },
  ...
  midnight: {
    ...
    shareButton: { backgroundColor: '#2a2a2a', textColor: '#00e5ff', fontSize: 13, fontWeight: '700' },
  ...
  legalPad: {
    ...
    shareButton: { backgroundColor: '#e6df8a', textColor: '#6a0dadB3', fontSize: 13, fontWeight: '700' },
  ...
  chalkboard: {
    ...
    shareButton: { backgroundColor: '#2f5745', textColor: '#ff8fd0CC', fontSize: 13, fontWeight: '700' },
  ...
  chalkboard2: {
    ...
    shareButton: { backgroundColor: '#4e4e4e', textColor: '#ffffff', fontSize: 13, fontWeight: '700' },
  ...
  retro: {
    ...
    shareButton: { backgroundColor: '#3d1a5c', textColor: '#ff2e9a', fontSize: 13, fontWeight: '700' },
